...
- :hugs: Try the trained models at the HuggingFace model hub:
  ...
  -  [[llama3-8b-instruct-lora-derta-100step]](https://huggingface.co/Youliang/llama3-8b-instruct-lora-derta-100step) based on [[Meta-Llama-3-8B-Instruct]](https://huggingface.co/meta-llama/Meta-Llama-3-8B-Instruct)
